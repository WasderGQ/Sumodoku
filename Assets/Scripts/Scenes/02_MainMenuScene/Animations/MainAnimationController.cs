...
namespace WasderGQ.Sudoku
{
    public class MainAnimationController : MonoBehaviour
    {
        ...
        public BackGroundAnimationController _backGroundAnimationController;
        ...
        public bool StopAnimation
        {
            set
            {
                _frontObjectAnimationController.StopAnimation = value;
                _backGroundAnimationController.StopAnimation = value;
            }
        }
